...
import { TerminalSquare, Mic, Brain, Radio, ArrowRight, Cloud, Zap } from "lucide-react"
import { Button } from "@/components/ui/button"

export function BlackBoxPreview() {
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold tracking-tighter mb-4 sm:mb-6">
              <span className="text-amber-500">Voice Commands</span> → Scout Control
            </h2>
            <p className="text-sm sm:text-base md:text-xl text-gray-300/90 max-w-3xl mx-auto leading-relaxed mb-8">
              BlackBox transforms speech into actionable commands for Scout systems. NLP analytics and speaker model training in one unified platform.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="border border-amber-500/20 bg-gradient-to-b from-[#0a0e1a] to-[#0f1625] p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 font-mono">Voice Input</h3>
              <p className="text-sm text-gray-400 font-light">
                Speech recognition and transcription in real-time.
              </p>
            </div>
              ...
              <div className="border border-amber-500/40 bg-gradient-to-b from-amber-500/10 to-[#0f1625] p-6 text-center transition-all duration-300 group-hover:border-amber-500/60 group-hover:shadow-[0_0_30px_rgba(245,158,11,0.3)] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-gray-300 font-light">
                    Commands executed on Scout fleet via ORBIT.
                  </p>
          ...
          <motion.div
            ...
            className="relative border border-amber-500/30 shadow-[0_0_25px_rgba(245,158,11,0.15)] mb-8"
          >
            {/* Terminal header */}
            <div className="bg-black border-b border-amber-500/30 p-2 flex items-center justify-between">
              ...
              <div className="text-[10px] text-amber-500/70 font-mono">
                <span className="bg-amber-500/10 px-1.5 py-0.5 rounded-sm">PREVIEW</span>
              </div>
            </div>
            ...
            <div className="p-4 md:p-6 bg-black">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="border border-amber-500/20 bg-gray-900/30 p-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Mic className="w-4 h-4 text-amber-500" />
                    <span className="text-xs text-amber-500 font-mono">VOICE COMMANDS</span>
                  </div>
                  <div className="space-y-1.5">
                    <div className="text-[10px] text-gray-400 font-mono">Recent: "SCOUT_07 proceed to waypoint alpha"</div>
                    <div className="text-[10px] text-green-400 font-mono">Status: EXECUTED</div>
                    <div className="text-[10px] text-gray-500 font-mono">Confidence: 96%</div>
                  </div>
                </div>

                {/* NLP Analytics Preview */}
                <div className="border border-amber-500/20 bg-gray-900/30 p-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Brain className="w-4 h-4 text-amber-500" />
                    <span className="text-xs text-amber-500 font-mono">NLP ANALYTICS</span>
                  </div>
                  <div className="space-y-1.5">
                    <div className="text-[10px] text-gray-400 font-mono">Intent Accuracy: 94%</div>
                    <div className="text-[10px] text-gray-400 font-mono">Entity Extraction: 91%</div>
                    <div className="text-[10px] text-amber-400 font-mono">↑ +2.3% this week</div>
                  </div>
                </div>

                {/* Model Training Preview */}
                <div className="border border-amber-500/20 bg-gray-900/30 p-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Radio className="w-4 h-4 text-amber-500" />
                    <span className="text-xs text-amber-500 font-mono">MODEL TRAINING</span>
                  </div>
                  <div className="space-y-1.5">
                    <div className="text-[10px] text-gray-400 font-mono">Active: OPERATOR_01</div>
                    <div className="text-[10px] text-gray-400 font-mono">Accuracy: 94.2%</div>
                    <div className="text-[10px] text-amber-400 font-mono">127 training samples</div>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-amber-500/20 bg-amber-500/5 p-4 text-center">
                <p className="text-sm text-gray-300 font-mono mb-4">
                  Full command center with live voice processing, NLP visualization, and model training available on ORBIT Cloud
                </p>
                <Link href="/orbit">
                  <Button className="bg-amber-500/12 hover:bg-amber-500/20 text-amber-500 border border-amber-500/30 hover:border-amber-500/50 px-6 py-3 text-sm font-normal transition-all duration-200 group">
                    <span className="flex items-center gap-2">
                      <Cloud className="w-4 h-4" />
                      View Full BlackBox Control Center
                      <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </span>
                  </Button>
                </Link>
          ...
          >
            {[
              { icon: <Mic className="w-5 h-5 text-amber-500" />, title: "Voice → Commands", desc: "Speech transcribed and executed on Scout systems" },
              { icon: <Brain className="w-5 h-5 text-amber-500" />, title: "NLP Analytics", desc: "Graphical visualization of transcript data" },
              { icon: <Radio className="w-5 h-5 text-amber-500" />, title: "Model Training", desc: "Fine-tune models for individual speakers" },
            ].map((feature, i) => (
